...
int main(int argc, char* argv[]) {
    ...
    Arena arena;
    Items* items = Arena::Create<Items>(&arena);
    Item* item = Arena::Create<Item>(&arena);
    NullRequest* null_request = Arena::Create<NullRequest>(&arena);
    SuccessResponse* success_response = Arena::Create<SuccessResponse>(&arena);
    FoundResponse* found_response = Arena::Create<FoundResponse>(&arena);
